...
from Models.blip_encoder import blip_encoder as blip_itm
...
def main():
    ...
    batch_size, task2num_iters, dset_train, dset_val, dl_train, dl_val = LoadDataset(args, config, task_cfg,args.task,data_imgs_root=None)
